...
<div class="container">
		...
		<h4 class="text-center" style="font-family: arial; padding-top: 10px; padding-bottom: 10px; font-style: italic; line-height: 29px; border-top: 2px solid #ff8d87; border-bottom: 2px solid #ff8d87;">Helsa Bakery adalah salah satu pelopor pertama dalam bisnis roti modern di Indonesia. Didirikan pada tahun 2023,  saat ini dikelola di bawah PT. Helsa Sentosa. Produk kami sehat, bergizi, dan terjangkau oleh semua orang.</h4>
